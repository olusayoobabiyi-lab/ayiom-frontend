...
const DETAILS_MAP = {
  evangelism: {
    ...
    faqs: [
      { q: "How can I join the evangelism team?", a: "You can sign up using the form below. We conduct training sessions for all new members before field deployments." },
      { q: "Do you organize outreaches outside the city?", a: "Yes, we regularly visit neighboring towns, villages, and schools as part of our rural missions." }
    ]
  },
  discipleship: {
    objectives: [
  ...
  outreach: {
    ...
    faqs: [
      { q: "Can non-medical professionals volunteer for medical outreaches?", a: "Absolutely! We need volunteers for registration, distribution of relief materials, crowd management, and prayer support." },
      { q: "Where does the funding for these outreaches come from?", a: "Our rural outreach missions are fully funded through donations from members and partners of the ministry." }
    ]
  },
  "school-support": {
    objectives: [
    ...
    faqs: [
      { q: "How are the beneficiary children selected?", a: "We work directly with community leaders, local schools, and social workers to identify children who are genuinely in need." },
      { q: "Can I sponsor a specific child's education?", a: "Yes! Please indicate 'Education Sponsorship' in your inquiry message below, and our team will get in touch with the details." }
    ]
  },
  "widows-care": {
    objectives: [
    ...
    faqs: [
      { q: "How often do you distribute food packages?", a: "We host our widows' welfare distribution on the second Saturday of every month." },
      { q: "How can I donate food or clothes?", a: "You can drop off donations at our outreach center, or reach out to us using the contact form to arrange a pickup." }
    ]
  },
  "orphans-care": {
    objectives: [
    ...
    faqs: [
      { q: "Do you operate an orphanage home directly?", a: "We partner with and support existing licensed orphanage homes and host community-based care projects." },
      { q: "Can I host a birthday or celebration with the children?", a: "Yes, we facilitate community visits. Please contact our coordinator via the form below." }
    ]
  },
  "prayer-intercession": {
    objectives: [
    ...
    faqs: [
      { q: "How can I submit a prayer request?", a: "You can send it through the form below or drop it in our physical prayer box at the center. Every request is prayed over." },
      { q: "Can anyone attend the prayer vigils?", a: "Yes! Our prayer vigils are open to all believers seeking a deeper prayer life." }
    ]
  },
  "volunteer-partnership": {
    ...
    faqs: [
      { q: "Is there a minimum commitment for volunteering?", a: "No, you can volunteer based on your availability—whether for one-off events or regular weekly service." },
      { q: "How do I become a financial partner?", a: "You can make a donation using the 'GIVE NOW' button at the top, or write to us for structured partnership options." }
    ]
  },
};
        ...
        <div className="w-full max-w-[1700px] mx-auto px-6 md:px-12 lg:px-16 grid grid-cols-1 lg:grid-cols-12 gap-12 xl:gap-16">
          ...
          <div className="lg:col-span-8 space-y-12">
            ...
            <div className="space-y-6">
              ...
              <p className="text-slate-600 text-sm md:text-base leading-relaxed font-medium">
                We believe that every believer is called to make a difference. Through {ministry.title.toLowerCase()}, we provide structured opportunities for community growth, service, and evangelism, ensuring that the love of Jesus is demonstrated in both word and deed.
              </p>
            </div>
              ...
              <div className="space-y-6">
                ...
                <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {extraDetails.objectives.map((obj, i) => (
                    <li key={i} className="flex gap-3 items-start bg-slate-50 rounded-xl p-5 border border-slate-100">
